...
CREATE TABLE VENTA (
  ...
  DIRECCION VARCHAR(80) NOT NULL,
  MONTOTOTAL DECIMAL(10,2) NOT NULL, -- Este campo puede ser calculado a partir de DETALLE_VENTA
...
-- Tabla para almacenar los detalles del tipo de pago
CREATE TABLE DETALLE_PAGO (
  IDPAGO INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
  IDVENTA INT NOT NULL,
  NUMEROTARJETA VARCHAR(16) DEFAULT NULL,
  FECHAVENCIMIENTO TIMESTAMP DEFAULT NULL,
...
delete from usuario_rol where idusuario = 5;
select * FROM usuario