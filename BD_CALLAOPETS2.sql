...
CREATE TABLE TRABAJADOR (
  IDTRABAJADOR INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
...
CREATE TABLE VENTA_PRODUCTO (
  ...
  CONSTRAINT FK_TRABAJADOR FOREIGN KEY (IDTRABAJADOR) REFERENCES TRABAJADOR (IDTRABAJADOR)
);
...
INSERT INTO cargo VALUES (1,'gerente'),(2,'asistente'),(3,'auxiliar'),(4,'técnico');
INSERT INTO area VALUES (1,'logística'),(2,'compras'),(3,'almacén'),(4,'ventas'),(5,'dirección');
...
INSERT INTO TRABAJADOR VALUES (1, "Moises","Rodicio","74033879","902074135","moises_rod@gmail.com","Elvira Rose 3050",4,4);
...
insert into venta_producto values (null, 1, "2023-12-01T13:47", "Av Venezuela con Av Fauccet", 51.6, 1, 1, 1);
